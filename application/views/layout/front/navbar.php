<section class="bg-white-custom">
    ...
    <nav class="navbar navbar-expand-lg fixed-top py-sm-3 py-xl-1 bg-white">
        <div class="container">
            ...
            <button class="navbar-toggler header-pc" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav"
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav gap-3 py-3">
                    <li class="nav-item">
                        <a class="nav-link <?= ($this->uri->uri_string() === '' || $this->uri->uri_string() === 'front') ? 'active' : '' ?>"
                            href="<?= site_url('front') ?>">Beranda</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= ($this->uri->segment(2) === "listClass") ? 'active' : '' ?>"
                            href="<?= site_url('front/listClass') ?>">Kursus</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= ($this->uri->segment(2) === "support") ? 'active' : '' ?>"
                            href="<?= site_url('front/support') ?>">Bantuan</a>
                    </li>
                </ul>
            </div>
