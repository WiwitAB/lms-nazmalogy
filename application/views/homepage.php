...
<body>
  ...
  <div class="d-flex">
    ...
    <div class="col-lg-4 d-none d-lg-inline" style="padding-top:5rem">
      <div class="w-100" style="background-image: url('<?= base_url('assets/img/bg_side.png') ?>');background-size: contain;height:100%">
      </div>
    </div>
  </div>
  <!-- section 1 - Hero Section -->
      ...
      <div class="py-3">
        <div class="row">
          ...
          <div class="col-lg-7" data-aos="zoom-in" data-aos-duration="1500">
            <div class="my-lg-4">
              <h2 class="fw-bold mb-4 text-white text-legend">Yang Bisa Kami Berikan</h2>
              <div class="row">
    ...
    <div class="container">
      <div class="email-area w-100 mt-md-3 py-md-5 pb-5" data-aos="zoom-in-up" data-aos-duration="1500">
        <div class="text-center">
          ...
          <div class="card-email mx-auto bg-first pt-5 p-4 rounded" style="margin-top:-30px">
