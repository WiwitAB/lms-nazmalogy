                        ...
                        <div class="summary__information">
                            <div class="info-card">
                                ...
                                <div id="close__form__profile" class="info-card-content">
                                    ...
                                    <div id="button__show__form__profile" onclick="openFormProfile()"
                                        class="edit-profile px-4 pb-3">
                                ...
                                <div id="show__form__profile" class="info-card-content p-4">
                                    <form action="">
                                        ...
                                        <div class="mb-2 p-2 px-4">
                                            ...
                                            <textarea rows="10" class="form-control" placeholder="Leave a comment here"
                                                id="floatingTextareaDisabled">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Molestias dolorem sapiente placeat beatae voluptates, accusantium aspernatur tenetur iusto explicabo cupiditate cumque facere minima error deleniti, fugit sit necessitatibus, blanditiis quidem.</textarea>
                                        </div>
                                    ...
                                    <div class="px-4">
                                        <button id="button__close__form__profile" onclick="closeFormProfile()"
                                            class="btn btn-primary mt-2 bg-first w-100 text-xl">
                                            <i class="bx bx-x"></i>
                                            Batal Edit
                                        </button>
                                    </div>
                            ...
                            <div class="info-card">
                                ...
                                <div class="info__card__head">
                                    <div class="d-flex justify-content-between py-4 px-4">
                                        ...
                                        <button id="edit__button__info" onclick="openFormInfo()"
                                            class="btn btn-outline-warning bg-yellow text-xl">
                                            <i class="bx bx-edit"></i>
                                            Edit Informasi
                                        </button>
                                        <button id="show__button__info" onclick="closeFormInfo()"
                                            class="btn btn-primary bg-first">
                                ...
                                <div id="display__info__content" class="info__card__content">
                                    ...
                                    <div class="personal-info-table px-4 pb-2">
                                        <div class="mb-2 p-2">
                                            ...
                                            <input type="text" class="form-control"
                                                placeholder="muhafifudin2306@gmail.com" disabled>
                                        </div>
                                        <div class="mb-2 p-2">
                                    ...
                                    <div class="personal-info-table px-4 pb-4 p-2">
                                        <div class="mb-2 p-2">
                                            ...
                                            <textarea rows="4" class="form-control" placeholder="Leave a comment here"
                                                id="floatingTextarea"
                                                disabled>Jl. Selokan Mataram Jl. Pogung Dalangan No.16, RT.11/RW.50, Pogung Kidul, Sinduadi</textarea>
                                        </div>
                                        <div class="d-flex justify-content-between flex-wrap">
                                            ...
                                            <div class="mb-2 w-50 p-2">
                                                ...
                                                <input type="text" class="form-control"
                                                    placeholder="Daerah istimewa Yogyakarta" disabled>
                                            </div>
                                            <div class="mb-2 w-50 p-2">
                                    ...
                                    <div class="personal-info-table px-4 py-4">
                                        <form action="">
                                            <div class="mb-2 p-2">
                                                <label for="disabledTextInput" class="form-label">Email Anda</label>
                                                <input type="text" class="form-control"
                                                    placeholder="muhafifudin2306@gmail.com">
                                            </div>
                                            <div class="mb-2 p-2">
                                            ...
                                            <div class="mb-2 p-2">
                                                ...
                                                <textarea rows="4" class="form-control"
                                                    placeholder="Leave a comment here">Jl. Selokan Mataram Jl. Pogung Dalangan No.16, RT.11/RW.50, Pogung Kidul, Sinduadi</textarea>
                                            </div>
