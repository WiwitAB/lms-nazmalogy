                                ...
                                <div class="d-flex flex-column">
                                    <div class="class-image">
                                        ...
                                        <div class="like-bottom my-auto mt-auto">
                                            <i id="2" onclick="likeFunction(this.id)" class="position-absolute bx bx-bookmark like_icon"></i>
                                        </div>
                                    </div>
                                    <div class="class-tag">
                            ...
                            <div class="card-class" data-aos="fade-up" data-aos-duration="700">
                                <div class="d-flex flex-column">
                                    <div class="class-image">
                                        ...
                                        <div class="marker"></div>
                                        <div class="like-bottom my-auto mt-auto">
                                            <i id="4" onclick="likeFunction(this.id)" class="position-absolute bx bx-bookmark like_icon"></i>
                                        </div>
                                    </div>
                                    <div class="class-tag">
                                        <button class="btn btn-outline-warning text-lg">marketing</button>
                                    ...
                                    <div class="class-title">
                                        <h6 class="ft-7 p-2">Membangun Ketangguhan Bisnis dengan
                            ...
                            <div class="card-class" data-aos="fade-up" data-aos-duration="700">
                                <div class="d-flex flex-column">
                                    <div class="class-image">
                                        ...
                                        <div class="marker"></div>
                                        <div class="like-bottom my-auto mt-auto">
                                            <i id="6" onclick="likeFunction(this.id)" class="position-absolute bx bx-bookmark like_icon"></i>
                                        </div>
                                    </div>
                                    <div class="class-tag">
                                        <button class="btn btn-outline-warning text-lg">marketing</button>
                            ...
                            <div class="card-class" data-aos="fade-up" data-aos-duration="700">
                                <div class="d-flex flex-column">
                                    <div class="class-image">
                                        ...
                                        <div class="marker"></div>
                                        <div class="like-bottom my-auto mt-auto">
                                            <i id="8" onclick="likeFunction(this.id)" class="position-absolute bx bx-bookmark like_icon"></i>
                                        </div>
                                    </div>
                                    <div class="class-tag">
                                        <button class="btn btn-outline-warning text-lg">marketing</button>
                            ...
                            <div class="card-class" data-aos="fade-up" data-aos-duration="700">
                                <div class="d-flex flex-column">
                                    <div class="class-image">
                                        ...
                                        <div class="marker"></div>
                                        <div class="like-bottom my-auto mt-auto">
                                            <i id="10" onclick="likeFunction(this.id)" class="position-absolute bx bx-bookmark like_icon"></i>
                                        </div>
                                    </div>
                                    <div class="class-tag">
                                        <button class="btn btn-outline-warning text-lg">marketing</button>
                            ...
                            <div class="card-class" data-aos="fade-up" data-aos-duration="700">
                                <div class="d-flex flex-column">
                                    <div class="class-image">
                                        ...
                                        <div class="marker"></div>
                                        <div class="like-bottom my-auto mt-auto">
                                            <i id="12" onclick="likeFunction(this.id)" class="position-absolute bx bx-bookmark like_icon"></i>
                                        </div>
                                    </div>
                                    <div class="class-tag">
                                        <button class="btn btn-outline-warning text-lg">marketing</button>
                            ...
                            <div class="card-class" data-aos="fade-up" data-aos-duration="700">
                                <div class="d-flex flex-column">
                                    <div class="class-image">
                                        ...
                                        <div class="marker"></div>
                                        <div class="like-bottom my-auto mt-auto">
                                            <i id="14" onclick="likeFunction(this.id)" class="position-absolute bx bx-bookmark like_icon"></i>
                                        </div>
                                    </div>
                                    <div class="class-tag">
                                        <button class="btn btn-outline-warning text-lg">marketing</button>
                            ...
                            <div class="card-class" data-aos="fade-up" data-aos-duration="700">
                                <div class="d-flex flex-column">
                                    <div class="class-image">
                                        ...
                                        <div class="marker"></div>
                                        <div class="like-bottom my-auto mt-auto">
                                            <i id="1" onclick="likeFunction(this.id)" class="position-absolute bx bx-bookmark like_icon"></i>
                                        </div>
                                    </div>
                                    <div class="class-tag">
                                        <button class="btn btn-outline-warning text-lg">marketing</button>
